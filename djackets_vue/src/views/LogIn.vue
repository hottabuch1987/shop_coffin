...
<div class="signup__container">
  <div class="container__child signup__thumbnail">
    ...
    <div class="thumbnail__content text-center">
      <h1 class="heading--primary">Войти</h1>
      <h5>Цены на VIP гробы выражаются шести, а то и семизначными цифрами. Покупка любой модели класса люкс выкажет максимальное уважение покойному. Ваш близкий достоин подобных почестей.
      </h5>
    </div>
  ...
  <div class="container__child signup__form">
    <form @submit.prevent="submiForm">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="password" name="passwordRepeat" id="passwordRepeat" placeholder="введите пароль" required />
      </div>
      ...
      <div class="m-t-lg">
        <ul class="list-inline">
          <li>
            <input class="btn btn--form" type="submit" value="Войти" />
          </li>
          <li>
        ...
        async submiForm() {
            ...
            await axios
                ...
                .then(response => {
                    ...
                    axios.defaults.headers.common['Authorization'] = "Token" + auth_code
