  ...
  <div class="container__child signup__thumbnail">
    ...
    <div class="thumbnail__content text-center">
      <h1 class="heading--primary">Регистрация</h1>
       <h5>Элитные гробы – это оригинальные похоронные изделия изготовленные из древесины твёрдых пород по специально разработанным эскизам. При создании авторских моделей основной акцент делается на солидный внешний вид, точную подгонку деталей, высокое качество материалов и индивидуальные пожелания заказчика. В начале технологического процесса древесина в обязательном порядке проходит обработку антипиритными и противогрибковыми средствами. Решив купить гроб элитный, обратите внимание на эксклюзивные модели из нашего каталога.
      </h5>
    </div>
  ...
  <div class="container__child signup__form">
    <form @submit.prevent="submiForm">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" name="email" id="email" placeholder="введите email" required v-model="email" />
      </div>
      <div class="form-group">
        <label for="password">Пароль</label>
        <input class="form-control" type="password" name="password" id="password" placeholder="введите пароль" required v-model="password" />
      </div>
      <div class="form-group">
        <label for="password2">Повтор пароля</label>
        <input class="form-control" type="password" name="password2" id="password2" placeholder="повторите пароль" required v-model="password2"/>
      </div>
      ...
      <div class="m-t-lg">
        <ul class="list-inline">
          <li>
            <input class="btn btn--form" type="submit" value="Регистрация" />
          </li>
          <li>
...
export default {
    ...
    methods: {
        submiForm() {
            ...
            if (this.email === '') {
                this.errors.push('E-mail не должно быть пустым')
            }
...
.heading--secondary {font-size: .414rem;}
.thumbnail__links {
  align-self: flex-end;
  width: 100%;
}
