...
<div class="signup__container">
  <div class="container__child signup__thumbnail">
    ...
    <div class="thumbnail__content text-center">
      <h1 class="heading--primary">Наши модели</h1>
       <h5>Представленные на сайте модели элитных гробов создаются по индивидуальным меркам на заказ. Мы ценим ваше внимание к усопшему и гарантируем изготовление ритуального изделия в кратчайшие сроки. Доставка по Москве и Московской области производится бесплатно</h5>
    </div>
  ...
  <div class="container__child signup__form">
    <form @submit.prevent="submiForm">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" name="auth_code" id="auth_code" placeholder="введите код подтверждения" required v-model="auth_code" />
      </div>
      ...
      <div class="m-t-lg">
        <ul class="list-inline">
          <li>
            <input class="btn btn--form" type="submit" value="Зарегистрироваться" />
          </li>
          <li>
...
export default {
    ...
    methods: {
        submiForm() {
            ...
            if (this.auth_code === '') {
                this.errors.push('Код пдтверждения не должен быть пустым')
            }
            ...
            if (!this.errors.length) {
                ...
                axios
                    .patch('api/auth/registration/', formData)
                    .then(response =>{
                        toast ({
                    ...
                    .catch(error =>{
                        if (error.response) {
                            this.error.push('Код действителен в течении 5 минут, Вы ввели не верный код, попробуйте еще раз')
